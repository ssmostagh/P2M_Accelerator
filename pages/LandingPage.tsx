    ...
    <div className="h-full overflow-auto bg-gray-900">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          <Link
            to="/ufp"
            className="bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-purple-500 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/20 group"
          >
            <div className="mb-4">
          ...
          <Link
            to="/moodboard"
            className="bg-gray-800 rounded-lg p-6 border border-gray-700 hover:border-blue-500 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/20 group"
          >
            <div className="mb-4">
          ...
          {/* Tech Pack */}
          <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 opacity-60 relative">
            <div className="absolute top-4 right-4 bg-gray-700 text-gray-300 text-xs px-2 py-1 rounded">
              Coming Soon
            </div>
            <div className="mb-4">
              <div className="w-16 h-16 bg-gradient-to-br from-teal-500 to-green-500 rounded-lg flex items-center justify-center mb-4">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-gray-800 rounded-lg p-8 border border-gray-700">
          <h3 className="text-2xl font-bold text-white mb-6 text-center">Why Use P2M Accelerator?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-white mb-2">Rapid Acceleration</h4>
              <p className="text-sm text-gray-400">Complete design cycles in hours, not weeks</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">Leveraging Google's Gemini technology</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">Production-ready designs and visuals</p>
            </div>
          </div>
        </div>
      </div>
