...
const App: React.FC = () => {
  ...
  return (
    <div className="h-screen p-4 sm:p-6 lg:p-8 bg-gray-900 font-sans flex flex-col">
      <header className="mb-6 flex-shrink-0">
        <h1 className="text-4xl font-bold text-center text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">
          P2M Accelerator: UFP Design Studio
        </h1>
        <p className="text-center text-sm text-gray-400 mt-1">Built by: mostaghim@</p>
      </header>
