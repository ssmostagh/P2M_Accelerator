...
export default function LandingPage() {
  return (
    <div className="h-full overflow-y-auto bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
          ...
          <Link
            to="/designstudio"
            className="bg-white dark:bg-gray-800 rounded-lg p-5 border border-gray-200 dark:border-gray-700 hover:border-purple-500 transition-all duration-300 hover:shadow-xl hover:shadow-purple-500/20 group"
          >
            <div className="mb-3">
          ...
          <Link
            to="/moodboard"
            className="bg-white dark:bg-gray-800 rounded-lg p-5 border border-gray-200 dark:border-gray-700 hover:border-blue-500 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/20 group"
          >
            <div className="mb-3">
          ...
          <Link
            to="/techpack"
            className="bg-white dark:bg-gray-800 rounded-lg p-5 border border-gray-200 dark:border-gray-700 hover:border-teal-500 transition-all duration-300 hover:shadow-xl hover:shadow-teal-500/20 group"
          >
            <div className="mb-3">
        ...
        {/* Feature Highlights */}
        <div className="bg-white dark:bg-gray-800 rounded-lg p-5 border border-gray-200 dark:border-gray-700 transition-colors duration-200">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 text-center">Why Use P2M Accelerator?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white mb-1 text-sm">Rapid Acceleration</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400">Complete design cycles in hours, not weeks</p>
            </div>
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white mb-1 text-sm">AI-Powered</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400">Leveraging Google's Gemini technology</p>
            </div>
            <div className="text-center">
              ...
              <h4 className="font-semibold text-gray-900 dark:text-white mb-1 text-sm">Professional Quality</h4>
              <p className="text-xs text-gray-500 dark:text-gray-400">Production-ready designs and visuals</p>
            </div>
          </div>
        </div>
      </div>
